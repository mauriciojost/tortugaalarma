...
\caption{
\small
Mariposa para decimación en frecuencia. Constituye el bloque básico para el algoritmo de FFT.}
\label{F:Mariposa}
\end{figure}
\bigskip
...
\caption{
\small
Recursividad de FFT con decimación en frecuencia. Ejemplo con vector de 8 muestras.}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.65]{balance_16_4.jpg}
\caption{
\small

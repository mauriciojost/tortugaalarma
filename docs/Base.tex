...
\fancypagestyle{plain}
{
    ...
    \fancyhead[LO]{\ECFTeenSpirit Mauricio G. Jost}         %Encabezado
...
\section{Mediciones}
Las mediciones tomadas muestran tiempos para diferentes tamaños de vector, y para diferente cantidad de procesadores.
